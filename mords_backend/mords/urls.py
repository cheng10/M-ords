...
urlpatterns = [
    ...
    url(r'^word/(?P<word_text>.+)/results/$', views.results, name='results'),
    url(r'^word/(?P<word_text>.+)/comment/$', views.comment, name='comment'),
    url(r'^word/(?P<word_text>.+)/note/$', views.note, name='note'),
    url(r'^word/(?P<word_text>.+)/know/$', views.know, name='know'),
