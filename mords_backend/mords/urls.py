...
urlpatterns = [
    ...
    url(r'^word/(?P<word_text>[^/]+)/$', views.detail, name='detail'),
    url(r'^word/results/(?P<word_text>[^/]+)/$', views.results, name='results'),
    url(r'^word/comment/(?P<word_text>[^/]+)$', views.comment, name='comment'),
    url(r'^word/note/(?P<word_text>[^/]+)$', views.note, name='note'),
    url(r'^word/know/(?P<word_text>[^/]+)$', views.know, name='know'),
