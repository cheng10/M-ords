...
urlpatterns = [
    ...
    url(r'^results/(?P<word_text>[^/]+)/$', views.results, name='results'),
    url(r'^comment/(?P<word_text>[^/]+)/$', views.comment, name='comment'),
    url(r'^tick/(?P<word_text>[^/]+)/$', views.tick, name='tick'),
    url(r'^cross/(?P<word_text>[^/]+)/$', views.cross, name='cross'),
